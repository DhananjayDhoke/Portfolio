...
// import resume from "../assets/Dhananjay_Dhoke_Resume.pdf";
...
import myGitDP from "./58-removebg-preview.png"
  ...
  return (
    <div ref={scrollRef}>
      ...
      >
        ...
        >
          ...
          <div className={styles.resumes}>
            <div className={styles.btn}>
              ...
              <a
                href="https://drive.google.com/file/d/1eZK0DHd3nPhtceuDgtGJzGXnXweXeEls/view?usp=sharing"
                target="_blank"
                rel="noreferrer"
              >
                <Button
            ...
            {/* <div className={styles.btn}>
              ...
              <a
                href="https://drive.google.com/file/d/1su2uEaKeSQEFzW69frEZqYMIJWJYZ5uy/view?usp=sharing"
                target="_blank"
              >
                <Button
                  text={
        ...
        >
          <img src={myGitDP} alt="Profile pic" />
        </div>
      </div>
