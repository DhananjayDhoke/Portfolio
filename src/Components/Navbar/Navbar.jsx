...
import sLogo from "./159-1596924_supermanlogo-gold-logo-freetoedit-superman-svg-file-free-removebg-preview.png"
  ...
  return (
    ...
    >
      <div className={styles.navbar}>
        <a href="https://dhananjay-dhoke-portfolio.netlify.app/">
